    ...
    products: [
      {
        ...
        smallimages: [
          ...
          "http://127.0.0.1:5173/src/assets/images/small2.jpg",
          "http://127.0.0.1:5173/src/assets/images/small3.jpg",
        ],
        quantity: 5,
        cat:1,
...

      {
        ...
        priceAfter: 170,
        priceBefore: 250,
        img: "http://127.0.0.1:5173/src/assets/images/dress3.jpg",
        state: "No Avialable",
        description:
          "A black abaya with a modern and distinctive design with sadu details and soft beads from the sleeves ",
        sizes: [50, 56],
        smallimages: [
          "http://127.0.0.1:5173/src/assets/images/dress3.jpg",
          "http://127.0.0.1:5173/src/assets/images/small2.jpg",
          "http://127.0.0.1:5173/src/assets/images/small3.jpg",
        ],
        quantity: 5,
...

      {
        ...
        priceAfter: 500,
        priceBefore: 760,
        img: "http://127.0.0.1:5173/src/assets/images/dress4.jpg",
        state: "Avialable",
        description:
          "A black abaya with a modern and distinctive design with sadu details and soft beads from the sleeves ",
        sizes: [50, 52, 54, 56, 58],
        smallimages: [
          "http://127.0.0.1:5173/src/assets/images/dress4.jpg",
          "/src/assets/images/small2.jpg",
          "/src/assets/images/small3.jpg",
        ],
        quantity: 1,
...

      {
        ...
        priceAfter: 300,
        priceBefore: 630,
        img: "http://127.0.0.1:5173/src/assets/images/dress5.jpg",
        state: "Avialable",
        description:
          "A black abaya with a modern and distinctive design with sadu details and soft beads from the sleeves ",
        sizes: [54, 56],
        smallimages: [
          "http://127.0.0.1:5173/src/assets/images/dress5.jpg",
          "http://127.0.0.1:5173/src/assets/images/small2.jpg",
          "http://127.0.0.1:5173/src/assets/images/small3.jpg",
        ],
        quantity: 4,
